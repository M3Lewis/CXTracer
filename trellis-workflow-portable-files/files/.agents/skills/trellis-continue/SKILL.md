...
- `status=in_progress` + check failed with unclear cause, user target correction, or repeated same-class failure → **2.3** and run `trellis-explore` before another implementation attempt
