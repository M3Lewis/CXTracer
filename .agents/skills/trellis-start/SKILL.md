...
| Check failed with unclear cause / user corrected target / ambiguous component or behavior | `trellis-explore` |
| Retrospective after fixing the same bug multiple times | `trellis-break-loop` |
